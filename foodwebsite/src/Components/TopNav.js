    ...
    <div className='max-w-[1520px] mx-auto flex justify-between items-center p-4'>
       <div className='flex items-center'>
        ...
        <div className='hidden lg:flex items-center bg-gray-200 rounded-full p-1 text-[14px]'>
          ...
          <p className='p-2 text-bold'>Deleivery</p>
        </div>
      
       </div>
       <div className='bg-gray-200 rounded-full flex items-center px-[12px] w-[200px] sm:w0[400px] lg:w-[500px]' >
       <AiOutlineSearch size={25}/>
       <input className='bg-transparent p-2 w-full focus:outline-none' type='text' placeholder='search meals'></input>
       </div>
       <button className='bg-orange-700 text-white hidden md:flex items-center px-10 py-3 rounded-full'>
       ...
       </button>
       {
        ...
        <nav>
          <ul className='flex flex-coloumn p-4 text-gray-900'>
